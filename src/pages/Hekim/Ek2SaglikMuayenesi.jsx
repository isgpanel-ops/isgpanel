...
import {
  ...
  HeartPulse, Image, Search, Stethoscope, TriangleAlert, UserRound,
} from "lucide-react";
...
export default function Ek2SaglikMuayenesi() {
  ...
  const open = (type, person) => {
    ...
    const fallback = type === "kisiselBilgiler" ? emptyPersonal() : type === "muayene" ? emptyExam() : {};
  ...
  return <div className="p-3 sm:p-4 md:p-6 space-y-3">
    <div><h1 className="text-xl font-bold text-[#042f4b]">EK-2 Sağlık Muayenesi</h1><p className="mt-1 text-sm text-slate-500">Firma çalışanlarının sağlık muayene süreçlerini takip edebilir ve EK-2 formlarını toplu olarak oluşturabilirsiniz.</p></div>
