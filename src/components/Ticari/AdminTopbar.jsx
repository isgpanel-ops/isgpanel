          ...
          <div className="relative shrink-0" ref={menuRef}>
            ...
            {menuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white border rounded-lg shadow-lg z-50 overflow-hidden">
                ...
                <button type="button" onClick={() => { setMenuOpen(false); navigate("/ticari/admin/isg-fatura-entegrasyonu"); }} className="w-full text-left px-4 py-3 text-sm hover:bg-gray-50 text-gray-700">İSG Fatura Entegrasyonu</button>
      ...
      {menuOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-white border rounded shadow-lg z-50">
          <ul className="text-sm text-gray-700">
            ...
            <li onClick={() => { navigate("/ticari/admin/isg-fatura-entegrasyonu"); setMenuOpen(false); }} className="px-4 py-2 hover:bg-gray-100 cursor-pointer">İSG Fatura Entegrasyonu</li>
