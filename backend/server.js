...
const isgFaturaIntegrationRoutes = require("./routes/isgFaturaIntegration");
const isgFaturaBillingFeedRoutes = require("./routes/isgFaturaBillingFeed");
...
const mailIntegrationRoutes = require("./routes/mailIntegrations");
...
app.use("/api/isg-fatura-integration", isgFaturaIntegrationRoutes);
app.use("/api/integrations/isg-fatura", isgFaturaBillingFeedRoutes);
...
app.use("/api/mail-integrations", mailIntegrationRoutes);
